...
class Menu:
    def __init__(self, screen, dashboard, level, sound, choosenPlayer="Strong Shiba.png"):
        self.screen = screen
        self.sound = sound
        self.start = False
        ...
        self.spritesheet = Spritesheet("./img/title_screen.png") #change banner
    ...
    def drawMenuBackground(self, withBanner=True):
        ...
        if withBanner:
            self.screen.blit(self.menu_banner, (80, 80)) #change banner
