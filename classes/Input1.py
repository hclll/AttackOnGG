...
class Input1:
    ...
    def checkForKeyboardInput(self):
        ...
        if pressedKeys[K_a] and not pressedKeys[K_d]:
            self.entity.traits["goTrait"].direction = -1
        elif pressedKeys[K_d] and not pressedKeys[K_a]:
            self.entity.traits["goTrait"].direction = 1
        else:
            self.entity.traits['goTrait'].direction = 0

        isJumping = pressedKeys[K_w]
        
        isFencing = pressedKeys[K_q]
        isShooting = pressedKeys[K_e]
